...
int main()
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        xs[i] = {
            .r     = { { .lb = 0.01, .cv = 0.01, .cc = 0.01, .ub = 0.01 } },
            .S0    = { { .lb = 99, .cv = 99.5, .cc = 100.5, .ub = 101 } },
            .tau   = { { .lb = 0.01 * v, .cv = 0.01 * v, .cc = 0.01 * v, .ub = 0.01 * v } },
            .K     = { { .lb = 95, .cv = 95, .cc = 95, .ub = 95 } },
            .sigma = { { .lb = 0.5, .cv = 0.5, .cc = 0.5, .ub = 0.5 } },
        };
    }
